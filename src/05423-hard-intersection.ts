...
type Intersection<T extends unknown[]>
   = {[I in keyof T]: (this: T[I] extends unknown[] ? T[I][number] : T[I]) => 0}[number] extends (this: infer I) => 0 ? I : never
...
type A = (2 | 3) & (3) & (2 | 3)
type T1 = Intersection<[[1, 2, 3], [2, 3, 4], [2, 2, 3]]>
type T2 = Intersection<[[1, 2, 3], 2 | 3 | 4, 3]>
